...
<head>
    ...
    <title><?php echo ucfirst($_SESSION['role']); ?> Registration - EduConnect</title>
...
<body>
    <div class="container">
        ...
        <h2><?php echo ucfirst($_SESSION['role']); ?> Registration</h2>
        
        <div class="register-info">
            <i class="fas fa-info-circle"></i> 
            Create your <?php echo $_SESSION['role']; ?> account to access the <?php echo $_SESSION['role']; ?> dashboard and features.
        </div>
